...
interface AuthShellProps extends PropsWithChildren {
  /** Brand glyph rendered on the brand plane. Defaults keep the user brand. */
  icon?: LucideIcon;
  /** Brand title on the brand plane. Defaults keep the user brand. */
  title?: string;
  /** Brand-plane supporting line under the title. */
  subtitle: string;
 ...
 * Brand + rail content are centered within their planes. Icon never pulses.
 * The brand plane is parameterized (icon + title) so the admin can pass
 * Server / "Aratiri Admin" without touching the user frontend.
 */
