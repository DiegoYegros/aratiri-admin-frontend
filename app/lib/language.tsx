...
const translations: TranslationDictionary = {
  en: {
    ...
    webhooks: {
      title: "Webhooks",
      subtitle: "Destinations that receive signed events.",
      modes: {
        endpoints: "Endpoints",
      ...
      filters: {
        ...
        all: "All",
        eventTypePlaceholder: "e.g. invoice.settled",
      },
      form: {
        createTitle: "Add endpoint",
        editTitle: "Edit endpoint",
        helper:
          "HTTPS destinations receive HMAC-SHA256 signed callbacks.",
        name: "Name",
        url: "URL",
        enabled: "Enabled",
        enabledHelper:
          "When disabled, no new deliveries are created for this endpoint.",
        events: "Event types",
        eventsHelper: "Choose which event types this destination receives.",
      ...
      secret: {
        ...
        warning:
          "This secret is shown once. Copy it now and store it safely. It cannot be recovered later.",
        label: "Signing secret",
        acknowledge: "I have saved this signing secret",
        done: "Done",
        copyFailed: "Could not copy. Select the secret and copy it manually.",
        createdNotice:
          "Endpoint created. Signing secret will not be shown again.",
        rotatedNotice:
          "Signing secret rotated. Integrators must update the HMAC secret.",
      },
      rotate: {
        title: "Rotate signing secret",
        confirm:
          "Rotate now? The current secret will stop working immediately.",
      },
      test: {
      ...
      retry: {
        ...
        confirmFailed: "Retry this failed delivery?",
      },
      empty: {
        endpoints: "No webhook endpoints yet.",
        deliveries: "No deliveries yet. Send a test event from an endpoint.",
        deliveriesFiltered: "No deliveries match these filters.",
      },
      detail: {
      ...
      errors: {
        fetchEndpoints: "Failed to load webhook endpoints.",
        fetchDeliveries: "Failed to load webhook deliveries.",
        save: "Failed to save endpoint.",
        rotate: "Failed to rotate signing secret.",
        test: "Failed to queue test event.",
        retry: "Failed to queue retry.",
        missingSecret:
          "The server did not return a signing secret. Try again.",
      },
    },
  },
  es: {
    ...
    webhooks: {
      title: "Webhooks",
      subtitle: "Destinos que reciben eventos firmados.",
      modes: {
        endpoints: "Endpoints",
        deliveries: "Entregas",
      },
      actions: {
        ...
        testing: "Encolando prueba…",
        viewDeliveries: "Ver entregas",
        rotate: "Rotar secreto de firma",
        retry: "Reintentar",
        retrying: "Encolando reintento…",
        details: "Detalles",
        save: "Guardar cambios",
        saving: "Guardando…",
        create: "Crear endpoint",
        creating: "Creando…",
        confirmRotate: "Rotar ahora",
      },
      table: {
        name: "Nombre",
        url: "URL",
      ...
      filters: {
        ...
        all: "Todos",
        eventTypePlaceholder: "ej. invoice.settled",
      },
      form: {
        createTitle: "Agregar endpoint",
        editTitle: "Editar endpoint",
        helper:
          "Los destinos HTTPS reciben callbacks firmados con HMAC-SHA256.",
        name: "Nombre",
        url: "URL",
        enabled: "Habilitado",
        enabledHelper:
          "Si está deshabilitado, no se crean nuevas entregas para este endpoint.",
        events: "Tipos de evento",
        eventsHelper: "Elige qué tipos de evento recibe este destino.",
        eventsRequired: "Selecciona al menos un tipo de evento.",
        saved: "Endpoint actualizado.",
      },
      secret: {
        title: "Secreto de firma",
        warning:
          "Este secreto se muestra una sola vez. Cópialo ahora y guárdalo de forma segura. No se puede recuperar después.",
        label: "Secreto de firma",
        acknowledge: "He guardado este secreto de firma",
        done: "Listo",
        copyFailed:
          "No se pudo copiar. Selecciona el secreto y cópialo manualmente.",
        createdNotice:
          "Endpoint creado. El secreto de firma no se volverá a mostrar.",
        rotatedNotice:
          "Secreto de firma rotado. Los integradores deben actualizar el secreto HMAC.",
      },
      rotate: {
        title: "Rotar secreto de firma",
        confirm:
          "¿Rotar ahora? El secreto actual dejará de funcionar de inmediato.",
      },
      test: {
        success: "Evento de prueba encolado.",
      },
      retry: {
        success: "Reintento encolado.",
        confirmFailed: "¿Reintentar esta entrega fallida?",
      },
      empty: {
        endpoints: "Aún no hay endpoints de webhook.",
        deliveries:
          "Aún no hay entregas. Envía un evento de prueba desde un endpoint.",
        deliveriesFiltered: "Ninguna entrega coincide con estos filtros.",
      },
      detail: {
      ...
      errors: {
        fetchEndpoints: "No se pudieron cargar los endpoints de webhook.",
        fetchDeliveries: "No se pudieron cargar las entregas de webhook.",
        save: "No se pudo guardar el endpoint.",
        rotate: "No se pudo rotar el secreto de firma.",
        test: "No se pudo encolar el evento de prueba.",
        retry: "No se pudo encolar el reintento.",
        missingSecret:
          "El servidor no devolvió un secreto de firma. Inténtalo de nuevo.",
      },
    },
  },
};
